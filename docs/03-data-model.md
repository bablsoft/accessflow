...
| `rate_limit_per_minute` | INTEGER, nullable — set via the admin surface (#871, `@Positive`), *enforced by #873*; `NULL` = unlimited |
| `rate_limit_per_day` | INTEGER, nullable — set via the admin surface (#871, `@Positive`), *enforced by #873*; `NULL` = unlimited |
