...
| [`frontend/src/pages/admin/`](../frontend/src/pages/admin/), [`frontend/src/pages/datasources/`](../frontend/src/pages/datasources/) — admin SPA pages | [`docs/index.html`](docs/index.html) configuration walkthroughs (Users, User groups, Datasources + ER diagram, Custom JDBC drivers, Review plans + templates, AI configs, AI analyses dashboard, Notifications, System SMTP, OAuth, SAML, Audit log) + matching PNGs under [`images/docs/`](images/docs/) |
