...
public final class MongoQueryEngine implements QueryEngine {
    ...
    private volatile MongoRowSecurityApplier rowSecurityApplier;
    ...
    public void initialize(QueryEngineContext context) {
        ...
        var applier = new MongoRowSecurityApplier(context.messages());
        this.clientManager = manager;
        this.parser = queryParser;
        this.rowSecurityApplier = applier;
        this.executor = new MongoQueryExecutor(manager, queryParser, applier,
                new MongoResultMapper(),
    ...
    public RowSecurityClassification classifyRowSecurity(QueryEngineRowSecurityRequest request) {
        ...
        return initialized(rowSecurityApplier).classify(ENGINE_ID, command, request.directives());
    }
