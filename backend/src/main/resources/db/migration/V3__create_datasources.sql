CREATE TYPE db_type_enum  AS ENUM ('POSTGRESQL', 'MYSQL');
CREATE TYPE ssl_mode_enum AS ENUM ('DISABLE', 'REQUIRE', 'VERIFY_CA', 'VERIFY_FULL');
...
CREATE TABLE datasources (
    ...
    ssl_mode              ssl_mode_enum NOT NULL DEFAULT 'DISABLE',
