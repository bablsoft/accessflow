 ...
 * field is optional — when omitted, the test reuses the currently-persisted replica password (lets
 * an admin re-test after changing only the URL or username without re-typing the secret).
 */
