...
public record BootstrapProperties(
        ...
        List<@Valid ServiceAccountSpec> serviceAccounts,
        List<@Valid ReviewPlanSpec> reviewPlans,
        List<@Valid AiConfigSpec> aiConfigs,
        List<@Valid DatasourceSpec> datasources,
        List<@Valid NotificationChannelSpec> notificationChannels,
        @Valid SamlSpec saml,
        List<@Valid OAuth2Spec> oauth2,
