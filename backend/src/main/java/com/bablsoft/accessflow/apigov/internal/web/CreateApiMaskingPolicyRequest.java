...
public record CreateApiMaskingPolicyRequest(
    ...
    public CreateApiConnectorMaskingPolicyCommand toCommand() {
        return new CreateApiConnectorMaskingPolicyCommand(matcherType, operationId, fieldRef, strategy,
