...
public class AiAnalysisEntity {
    ...
    // Nullable: an analysis may instead key off a request-group member (AF-501). Exactly one of the
    // four target columns is non-null, enforced by the chk_ai_analyses_target DB CHECK.
