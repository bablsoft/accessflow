 ...
 * engines.
 *
 * <p>{@link #RELATIONAL} is the JDBC/SQL umbrella; every other value is part of the NoSQL
 * umbrella: an engine-managed connector that connects through a native driver shipped as an
 * engine plugin (see {@code docs/15-engine-sdk.md}) and therefore carries no
 * {@code jdbcUrlTemplate} or {@code driverClassName}.
 *
 * <ul>
