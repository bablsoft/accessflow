...
/**
 * Shared connection helpers for the {@code core} MongoDB admin paths (connection test + schema
 * introspection). Builds a short-lived {@link MongoClient} from a datasource descriptor using the
 * shared {@link MongoConnectionStringFactory}, with tight admin-time timeouts so a misconfigured
