...
/** API envelope for the self-scoped API-request trend series (AF-500 dashboard). */
public record MyApiRequestTrendsResponse(
        List<StatusBucketResponse> statusByDay,
        List<RiskBucketResponse> riskByDay) {

    public static MyApiRequestTrendsResponse from(MyApiRequestTrendsRaw raw) {
        return new MyApiRequestTrendsResponse(
