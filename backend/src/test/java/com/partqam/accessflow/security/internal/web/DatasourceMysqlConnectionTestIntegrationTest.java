...
class DatasourceMysqlConnectionTestIntegrationTest {
    ...
    static void startCustomerDb() throws Exception {
        ...
        try (var connection = DriverManager.getConnection(customerDb.getJdbcUrl(),
            ...
            stmt.execute("CREATE TABLE customers (id CHAR(36) PRIMARY KEY, "
                    + "email VARCHAR(255) NOT NULL)");
            stmt.execute("CREATE TABLE orders (id CHAR(36) PRIMARY KEY, total INT, "
    ...
    @Test
    void testConnectionAgainstRunningMysqlReturnsOk() {
    ...
    void getSchemaAsAdminListsTables() throws Exception {
        ...
        assertThat(body).doesNotContain("performance_schema");
        assertThat(body).doesNotContain("\"name\":\"mysql\"");
        assertThat(body).doesNotContain("\"name\":\"sys\"");
    }
