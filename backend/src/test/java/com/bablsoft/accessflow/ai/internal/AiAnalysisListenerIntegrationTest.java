...
class AiAnalysisListenerIntegrationTest {
    ...
    @Autowired com.bablsoft.accessflow.ai.internal.persistence.repo.AiConfigRepository aiConfigRepository;
    ...
    void setUp() {
        ...
        var aiConfig = new com.bablsoft.accessflow.ai.internal.persistence.entity.AiConfigEntity();
        aiConfig.setId(UUID.randomUUID());
        aiConfig.setOrganizationId(org.getId());
        aiConfig.setName("Primary AI");
        aiConfig.setProvider(com.bablsoft.accessflow.core.api.AiProviderType.ANTHROPIC);
