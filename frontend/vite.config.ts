  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/api/deploymentFreezeWindows.ts',
        'src/api/deploymentPipelines.ts',
        'src/api/deploymentRequests.ts',
        'src/api/deploymentReviews.ts',
        'src/api/deploymentRoutingPolicies.ts',
        'src/api/deploymentVersions.ts',
        'src/api/datasourceHealth.ts',
        'src/api/updates.ts',
        'src/api/policySimulation.ts',
        'src/api/datasources.ts',
        'src/api/exportPolicies.ts',
        'src/api/grantUsage.ts',
        'src/api/privilegedAccess.ts',
        'src/api/accessSimulations.ts',
        'src/api/apiCallSimulations.ts',
        'src/api/deploymentSimulations.ts',
        'src/api/helpAgent.ts',
        'src/api/helpChat.ts',
        'src/api/maskingPolicies.ts',
        'src/api/resultExport.ts',
        ...
        'src/pages/admin/sqlReviewForm.ts',
        'src/pages/admin/service-accounts/serviceAccountForm.ts',
        'src/pages/admin/routingSimulationSummary.ts',
        'src/components/policies/policyImpact.ts',
        'src/components/policies/decisionTraceDetails.ts',
        'src/components/policies/typedIdOption.ts',
        'src/components/access/effectiveAccess.ts',
        'src/pages/queries/buildTimelineStages.ts',
        'src/pages/deployments/buildDeploymentTimelineStages.ts',
        'src/components/deployments/freezeWindowForm.ts',
