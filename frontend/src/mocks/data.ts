...
export const USERS: User[] = [
  { id: 'u-01', email: 'alice.chen@acme.com', display_name: 'Alice Chen', role: 'ANALYST', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T09:12:00Z', preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-02', email: 'marcus.holt@acme.com', display_name: 'Marcus Holt', role: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T08:44:00Z', preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-03', email: 'priya.raman@acme.com', display_name: 'Priya Raman', role: 'ADMIN', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T07:22:00Z', preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-04', email: 'jonas.weber@acme.com', display_name: 'Jonas Weber', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T18:01:00Z', preferred_language: null, created_at: '2026-02-02T11:30:00Z' },
  { id: 'u-05', email: 'mei.tanaka@acme.com', display_name: 'Mei Tanaka', role: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T06:30:00Z', preferred_language: null, created_at: '2026-02-09T08:15:00Z' },
  { id: 'u-06', email: 'david.okafor@acme.com', display_name: 'David Okafor', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-02T14:50:00Z', preferred_language: null, created_at: '2026-02-14T13:00:00Z' },
  { id: 'u-07', email: 'sara.lopez@acme.com', display_name: 'Sara Lopez', role: 'READONLY', auth_provider: 'LOCAL', active: true, last_login_at: '2026-04-29T11:11:00Z', preferred_language: null, created_at: '2026-02-20T09:45:00Z' },
  { id: 'u-08', email: 'tomas.novak@acme.com', display_name: 'Tomas Novak', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-01T16:25:00Z', preferred_language: null, created_at: '2026-03-01T10:20:00Z' },
  { id: 'u-09', email: 'aisha.bello@acme.com', display_name: 'Aisha Bello', role: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T07:55:00Z', preferred_language: null, created_at: '2026-03-04T15:00:00Z' },
  { id: 'u-10', email: 'lukas.berg@acme.com', display_name: 'Lukas Berg', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T20:18:00Z', preferred_language: null, created_at: '2026-03-08T11:10:00Z' },
  { id: 'u-11', email: 'noor.ahmed@acme.com', display_name: 'Noor Ahmed', role: 'ADMIN', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T09:01:00Z', preferred_language: null, created_at: '2026-03-15T08:00:00Z' },
  { id: 'u-12', email: 'kenji.sato@acme.com', display_name: 'Kenji Sato', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T05:30:00Z', preferred_language: null, created_at: '2026-03-21T14:30:00Z' },
  { id: 'u-13', email: 'isabel.cruz@acme.com', display_name: 'Isabel Cruz', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T13:40:00Z', preferred_language: null, created_at: '2026-03-28T09:00:00Z' },
  { id: 'u-14', email: 'oscar.fields@acme.com', display_name: 'Oscar Fields', role: 'READONLY', auth_provider: 'LOCAL', active: false, last_login_at: '2026-04-12T10:00:00Z', preferred_language: null, created_at: '2026-04-01T10:00:00Z' },
  { id: 'u-15', email: 'hana.kim@acme.com', display_name: 'Hana Kim', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T08:00:00Z', preferred_language: null, created_at: '2026-04-08T10:00:00Z' },
  { id: 'u-16', email: 'rafael.silva@acme.com', display_name: 'Rafael Silva', role: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T07:14:00Z', preferred_language: null, created_at: '2026-04-12T10:00:00Z' },
  { id: 'u-17', email: 'emma.larsen@acme.com', display_name: 'Emma Larsen', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-02T17:25:00Z', preferred_language: null, created_at: '2026-04-15T10:00:00Z' },
  { id: 'u-18', email: 'yuki.matsuda@acme.com', display_name: 'Yuki Matsuda', role: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T04:05:00Z', preferred_language: null, created_at: '2026-04-18T10:00:00Z' },
];
