...
export const USERS: User[] = [
  { id: 'u-01', email: 'alice.chen@acme.com', display_name: 'Alice Chen', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T09:12:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-02', email: 'marcus.holt@acme.com', display_name: 'Marcus Holt', role: 'REVIEWER', role_id: null, role_name: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T08:44:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-03', email: 'priya.raman@acme.com', display_name: 'Priya Raman', role: 'ADMIN', role_id: null, role_name: 'ADMIN', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T07:22:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-01-15T10:00:00Z' },
  { id: 'u-04', email: 'jonas.weber@acme.com', display_name: 'Jonas Weber', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T18:01:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-02-02T11:30:00Z' },
  { id: 'u-05', email: 'mei.tanaka@acme.com', display_name: 'Mei Tanaka', role: 'REVIEWER', role_id: null, role_name: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T06:30:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-02-09T08:15:00Z' },
  { id: 'u-06', email: 'david.okafor@acme.com', display_name: 'David Okafor', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-02T14:50:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-02-14T13:00:00Z' },
  { id: 'u-07', email: 'sara.lopez@acme.com', display_name: 'Sara Lopez', role: 'READONLY', role_id: null, role_name: 'READONLY', auth_provider: 'LOCAL', active: true, last_login_at: '2026-04-29T11:11:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-02-20T09:45:00Z' },
  { id: 'u-08', email: 'tomas.novak@acme.com', display_name: 'Tomas Novak', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-01T16:25:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-01T10:20:00Z' },
  { id: 'u-09', email: 'aisha.bello@acme.com', display_name: 'Aisha Bello', role: 'REVIEWER', role_id: null, role_name: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T07:55:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-04T15:00:00Z' },
  { id: 'u-10', email: 'lukas.berg@acme.com', display_name: 'Lukas Berg', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T20:18:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-08T11:10:00Z' },
  { id: 'u-11', email: 'noor.ahmed@acme.com', display_name: 'Noor Ahmed', role: 'ADMIN', role_id: null, role_name: 'ADMIN', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T09:01:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-15T08:00:00Z' },
  { id: 'u-12', email: 'kenji.sato@acme.com', display_name: 'Kenji Sato', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T05:30:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-21T14:30:00Z' },
  { id: 'u-13', email: 'isabel.cruz@acme.com', display_name: 'Isabel Cruz', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-03T13:40:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-03-28T09:00:00Z' },
  { id: 'u-14', email: 'oscar.fields@acme.com', display_name: 'Oscar Fields', role: 'READONLY', role_id: null, role_name: 'READONLY', auth_provider: 'LOCAL', active: false, last_login_at: '2026-04-12T10:00:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-04-01T10:00:00Z' },
  { id: 'u-15', email: 'hana.kim@acme.com', display_name: 'Hana Kim', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T08:00:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-04-08T10:00:00Z' },
  { id: 'u-16', email: 'rafael.silva@acme.com', display_name: 'Rafael Silva', role: 'REVIEWER', role_id: null, role_name: 'REVIEWER', auth_provider: 'LOCAL', active: true, last_login_at: '2026-05-04T07:14:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-04-12T10:00:00Z' },
  { id: 'u-17', email: 'emma.larsen@acme.com', display_name: 'Emma Larsen', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-02T17:25:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-04-15T10:00:00Z' },
  { id: 'u-18', email: 'yuki.matsuda@acme.com', display_name: 'Yuki Matsuda', role: 'ANALYST', role_id: null, role_name: 'ANALYST', auth_provider: 'SAML', active: true, last_login_at: '2026-05-04T04:05:00Z', totp_enabled: false, preferred_language: null, created_at: '2026-04-18T10:00:00Z' },
];

export const DATASOURCES: Datasource[] = [
  { id: 'ds-01', organization_id: 'org-demo', name: 'Production PostgreSQL', db_type: 'POSTGRESQL', host: 'db-prod.acme.internal', port: 5432, database_name: 'app_prod', username: 'accessflow_svc', ssl_mode: 'VERIFY_FULL', max_rows_per_query: 1000, require_review_writes: true, require_review_reads: false, ai_analysis_enabled: true, ai_config_id: null, text_to_sql_enabled: false, active: true, connection_pool_size: 25, review_plan_id: 'rp-strict', custom_driver_id: null, connector_id: null, jdbc_url_override: null, read_replicas: [], local_datacenter: null, result_cache_enabled: false, result_cache_ttl_seconds: null, created_at: '2026-01-15T10:00:00Z' },
...
export const CHANNELS: NotificationChannel[] = [
  ...
  { id: 'ch-04', organization_id: 'org-demo', channel_type: 'PAGERDUTY', name: 'PagerDuty On-Call', active: true, config: { routing_key: '********', default_severity: 'critical', triggers: ['CRITICAL_RISK', 'REVIEW_TIMEOUT'] }, created_at: '2026-05-01T22:30:00Z' },
